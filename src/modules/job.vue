...
<script setup>
import { jobList, selectJobUUID } from '../js/state'
import { handleGetJobList, handleCreateJob, handleGetJobInfo, handleStartJob, handleGetOutRescourceInfo, handleDownLoadFile } from '../js/job.js'
</script>